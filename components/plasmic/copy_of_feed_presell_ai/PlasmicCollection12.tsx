...
import sty from "./PlasmicCollection12.module.css"; // plasmic-import: ViY6AuzmQbUB/css
...
function PlasmicCollection12__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rvu2G)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__x8Sy5)}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__xXZ2)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__jo2LR)}>
        {p.renderPlasmicSlot({
          defaultContents: "\u2605\u2605\u2605\u2605\u2605 (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__hjL1)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox___1PiP)}>
        {p.renderPlasmicSlot({
