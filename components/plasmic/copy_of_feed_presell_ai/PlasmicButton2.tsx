...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: -l7pGZn4WKg/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: GFjIf2fkQZO9/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__fyNrA)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg___81AK)}
                role={"img"}
              />
            ),
