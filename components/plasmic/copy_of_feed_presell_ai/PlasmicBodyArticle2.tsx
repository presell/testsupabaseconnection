...
import sty from "./PlasmicBodyArticle2.module.css"; // plasmic-import: 51q5_iAULU1e/css
...
function PlasmicBodyArticle2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__bJQv9)}
        component={Link}
        href={(() => {
          try {
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__teeZe)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__oho9P)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___1BbIw)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__aiBFp)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__z3YQs)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__ysk6)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__uQux3)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            <div className={classNames(projectcss.all, sty.column__eQhA)}>
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img___6El5U)}
                displayHeight={
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? ("70%" as const)
                    : ("80%" as const)
            ...
            <div className={classNames(projectcss.all, sty.column__kwHss)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img___7Bxb)}
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__xqJs)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
