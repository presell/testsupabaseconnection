...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: AH-KmfMOh5r7/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__v4BQo)} />
            ) : null}
            <div className={classNames(projectcss.all, sty.column___6H1Js)}>
              <p.PlasmicLink
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__fnsp6)} />
            ) : null}
          </div>
        ) : null}
      </div>
